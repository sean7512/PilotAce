...
- (id)initWithScene:(SKScene<GameOverListener> *)scene withPlaneController:(AirplaneController *)planeController {
    ...
    if(self) {
        ...
        _nodeScale = [[GameSettingsController sharedInstance].nodeScaleDelegate getNodeScaleSize];
...
- (void)playActionSound:(SKAction *)actionSound {
    ...
    if((![gameSettings isOtherAudioPlaying]) && [gameSettings isSoundEffectsEnabled] && actionSound) {
